...
import './style/out-registered.less';
// import $ from 'jquery';
import forMatePost from './util/crypto';
var html = require('html-loader!./views/out-registered.html');
...
// 验证邀请码
$.ajax({
    url: '/ifinance' + '/user/checkInvitationCode',
    type: 'POST',
    data: forMatePost(),
...
$(".get-code").on("click", function () {
    // 获取手机号码
    var phone = $(".password-phone").val();
    $.ajax({
        url: '/ifinance' + '/user/createMemberAndSendCode',
        type: 'POST',
        data: forMatePost({
            mobile: phone,
            memberType: 3,
